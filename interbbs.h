...
#define PATH_CHARS         256
#define FILENAME_CHARS     256
#define MESSAGE_SUBJECT    "Galactic Dynasty Inter-BBS Door Message"
#define MESSAGE_PID        "\1PID: GDIBMS 1\r"
#define JAM_MSG_PID		   "GDIBMS 1"
